...
<div class="wrapper features-comparison-page">
              ...
              <div class="col-lg-10 offset-lg-1">
                <header class="entry-header">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <a class="text-uppercase text-secondary ml-auto" href="<?php echo esc_url( $roi_link ); ?>">Check ROI</a>
                  </div>
                                    ...
                                    ?>
                                      <div class="row no-gutters feature-entry">
                                        <?php
                                          $colIndex = 0;
                                          foreach ( $tr as $td ) {
                                            $colClass = $colIndex == 0 ? 'col-lg-8' : 'col-lg-2';
